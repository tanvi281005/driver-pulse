...
def goal_prediction(driver_id: str):
    ...
    prob = earnings_predictor.goal_probability(driver_id, start_time)
...
def today_stats(driver_id: str):
    ...
    goal_prob = earnings_predictor.goal_probability(driver_id, start_time)
...
def driver_goal(driver_id: str):
    ...
    info = earnings_predictor.goal_target_and_progress(driver_id, start_time)

    return {
        "target": round(float(info.get("target", 0)), 2),
